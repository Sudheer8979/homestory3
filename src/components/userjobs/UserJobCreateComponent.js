...
//import { GetJobList } from '../../actions/partners/PartnersActions';
...
class UserJobCreateComponent extends React.PureComponent {
  ...
  handleJobCreate = () => {
    ...
    this.props.PostJob(body, function (resObj) {
      if (resObj.statusCode === "9937") {
        ...
        toast.success(resObj.statusResult.jobId   +'Job Create Successfully');
        console.log(JSON.stringify(resObj.statusResult))
  ...
  handleJobTest =() => {
    ...
    var body = {
      startindex: this.state.paramaterList[0].stepOrder ? "start-index="+ this.state.paramaterList[0].stepOrder : '',
      limit: this.state.paramaterList[1] && this.state.paramaterList[1].stepOrder ? "&limit="+ this.state.paramaterList[1].stepOrder : '',
  ...
  render() {
    ...
    let programesList = this.state.programesList && this.state.programesList;
